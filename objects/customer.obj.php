...
class Customer
{
    ...
    {
        $sql = "SELECT MAX(customer_code) AS max_code FROM customer_tbl WHERE is_active = 1";
    ...
    public function update_customers()
    {
        ...
        $update_customer->bindParam(28, $this->id);
