                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h5>Masters / <b><a href="company.php">Company</a></b></h5>
                        </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="btn-group" style="margin-bottom: 15px;">
                                        <a href="add_company.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $view->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr data-id="' . htmlspecialchars($row['id']) . '">
                                                    <td class="text-center">' . htmlspecialchars($row['company_code']) . '</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <a class="edit" href="edit_company.php?id=' . htmlspecialchars($row['id']) . '"><i class="fa fa-edit"></i> Edit</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fa fa-eye"></i> View Company</h4>
