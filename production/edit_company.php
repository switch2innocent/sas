                                        ...
                                        <form>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="upd_company_code" name="company_code" value="' . $row['company_code'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_name">Company Name <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_name" name="company_name" value="' . $row['company_name'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_address">Company Address <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_address" name="company_address" value="' . $row['company_address'] . '" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                    <label for="city_notary">City Notary <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_city_notary" name="city_notary" value="' . $row['city_notary'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_city">Company City <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_city" name="company_city" value="' . $row['company_city'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_tin">Company TIN <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_tin" name="company_tin" value="' . $row['company_tin'] . '" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                    <label for="company_ctc">Company CTC <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_ctc" name="company_ctc" value="' . $row['company_ctc'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_ctc_date">Company CTC Date <span style="color:red">*</span></label>
                                                    <input type="date" class="form-control" id="upd_company_ctc_date" name="company_ctc_date" value="' . $row['company_ctc_date'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                    <label for="company_ctc_place">Company CTC Place <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_company_ctc_place" name="company_ctc_place" value="' . $row['company_ctc_place'] . '" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="upd_company_person_a" name="company_person_a" value="' . $row['company_person_a'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company_position_a">Company Position <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_company_position_a" name="company_position_a" value="' . $row['company_position_a'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company_person_tin_a">Company Person TIN <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_company_person_tin_a" name="company_person_tin_a" value="' . $row['company_person_tin_a'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="person_ctc_a">Person CTC <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_person_ctc_a" name="person_ctc_a" value="' . $row['person_ctc_a'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="person_ctc_date_place_a">Person CTC Date Place <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_person_ctc_date_place_a" name="person_ctc_date_place_a" value="' . $row['person_ctc_date_place_a'] . '" required>
                                                    </div>
                                                    </fieldset>
                                                </div>
                                                <!-- Personnel B -->
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="upd_company_person_b" name="company_person_b" value="' . $row['company_person_b'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company_position_b">Company Position <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_company_position_b" name="company_position_b" value="' . $row['company_position_b'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company_person_tin_b">Company Person TIN <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_company_person_tin_b" name="company_person_tin_b" value="' . $row['company_person_tin_b'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="person_ctc_b">Person CTC <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_person_ctc_b" name="person_ctc_b" value="' . $row['person_ctc_b'] . '" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="person_ctc_date_place_b">Person CTC Date Place <span style="color:red">*</span></label>
                                                        <input type="text" class="form-control" id="upd_person_ctc_date_place_b" name="person_ctc_date_place_b" value="' . $row['person_ctc_date_place_b'] . '" required>
                                                    </div>
                                                    </fieldset>
                                                </div>
                                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="upd_pagibig_person" name="pagibig_person" value="' . $row['pagibig_person'] . '" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                    <label for="pagibig_address">Pag-Ibig Address <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_pagibig_address" name="pagibig_address" value="' . $row['pagibig_address'] . '" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                    <label for="pagibig_position">Pag-Ibig Position <span style="color:red">*</span></label>
                                                    <input type="text" class="form-control" id="upd_pagibig_position" name="pagibig_position" value="' . $row['pagibig_position'] . '" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
